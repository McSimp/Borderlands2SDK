...
template<typename FuncHookType>
class CHookManager
{
public:
	typedef typename std::map<std::string, FuncHookType*> tHookMap;
	typedef typename tHookMap::iterator tiHookMap;
	typedef typename std::map<std::string, tHookMap>::iterator tiVirtualHooks;
	typedef typename std::map<UFunction*, tHookMap>::iterator tiStaticHooks;
	typedef typename std::pair<std::string, FuncHookType*> tFuncNameHookPair;
...
public:
	...
	void Register(const std::string& funcName, const std::string& hookName, FuncHookType* funcHook)
	{
