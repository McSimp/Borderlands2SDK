...
namespace BL2SDK
{
	namespace Signatures
	{
		...
		MemorySignature ProcessDeferredMessage = {
			"\x55\x8B\xEC\x6A\xFF\x68\x00\x00\x00\x00\x64\xA1\x00\x00\x00\x00\x50\x83\xEC\x14\x53\x56\x57\xA1\x00\x00\x00\x00\x33\xC5\x50\x8D\x45\xF4\x64\xA3\x00\x00\x00\x00\x8B\xF1\x8B\x45\x08",
			"xxxxxx????xx????xxxxxxxx????xxxxxxxx????xxxxx",
			45
		};

		MemorySignature GwenDestructor = {
			...
			"xxxxxx????xx????xxx????xxxxx????x????x????xxxx????xxxxxxxx????xxxxxxxx????xx",
			76
		};

		MemorySignature ViewportResize = {
			"\x55\x8B\xEC\x6A\xFF\x68\x00\x00\x00\x00\x64\xA1\x00\x00\x00\x00\x50\x81\xEC\x00\x00\x00\x00\xA1\x00\x00\x00\x00\x33\xC5\x89\x45\xF0\x53\x56\x57\x50\x8D\x45\xF4\x64\xA3\x00\x00\x00\x00\xBE",
			"xxxxxx????xx????xxx????x????xxxxxxxxxxxxxx????x",
			47
		};
